...
2. Сбросить выбранные параметры
    - После нажатия кнопки модальное окно скрывается и пользователь видит список всех своих контактов
...
2. Сбросить выбранный тип сортировки
    - После нажатия на кнопку модальное окно скрывается и пользователь видит список всех своих контактов в рандомном (случайном) порядке
